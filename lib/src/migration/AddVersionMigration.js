...
var AddVersionMigration = /** @class */ (function () {
    function AddVersionMigration() {
        this.tableName = "version";
    }
    AddVersionMigration.prototype.up = function (queryRunner) {
                            ...
                            columns: [
                                {
                                    ...
                                    type: queryRunner.connection.driver.normalizeType({
                                        type: queryRunner.connection.driver.mappedDataTypes.migrationId,
                                    }),
                                    isGenerated: true,
    ...
    AddVersionMigration.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return AddVersionMigration;
}());
exports.AddVersionMigration = AddVersionMigration;
//# sourceMappingURL=AddVersionMigration.js.map